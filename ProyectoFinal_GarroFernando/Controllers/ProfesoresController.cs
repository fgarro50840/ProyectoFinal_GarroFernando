...
namespace ProyectoFinal_GarroFernando.Controllers
{
    public class ProfesoresController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Profesores.Include(p => p.Usuario);
        ...
        public async Task<IActionResult> Create([Bind("Id,UsuarioId,Especialidad,Activo")] Profesor profesor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UsuarioId,Especialidad,Activo")] Profesor profesor)
        {
            if (id != profesor.Id)
            {
                return NotFound();
