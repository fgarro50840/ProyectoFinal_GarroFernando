...
namespace ProyectoFinal_GarroFernando.Controllers
{
    public class CursosController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Cursos.Include(c => c.Carrera);
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Codigo,Creditos,CarreraId")] Curso curso)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Codigo,Creditos,CarreraId")] Curso curso)
        {
            if (id != curso.Id)
            {
                return NotFound();
