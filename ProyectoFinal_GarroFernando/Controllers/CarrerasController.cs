...
namespace ProyectoFinal_GarroFernando.Controllers
{
    public class CarrerasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Codigo,Activa")] Carrera carrera)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Codigo,Activa")] Carrera carrera)
        {
            if (id != carrera.Id)
            {
                return NotFound();
